...
var brutefore = new ExpressBrute(store);
...
//login
router.post("/login",brutefore.prevent,async(req,res)=>{
    ...
    try{
        ...
        //Compare the provided password with the hash password in the database
